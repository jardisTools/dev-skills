...
- `DomainResponse`, `ContextResponse`, `DomainResponseTransformer`: generated per domain (`{Domain}\Response\`, Response-Trio, §7 above) — no longer package classes; `ResponseStatus` + the response/context interfaces: `jardissupport/contracts`
