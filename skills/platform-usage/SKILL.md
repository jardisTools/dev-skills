...
| 400 | 400 Bad Request | 2 | Field/DTO validation failed (before any Rule runs) — payload carries `data.request.fields[{field,reason}]` (E1, `frontend-adapter`, 2026-08-27) |
