...
| jardissupport/contracts | shared port interfaces and contracts for all Jardis packages | you need the interface definitions that Jardis adapters implement, without depending on any concrete implementation | — |
